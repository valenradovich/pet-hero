      ...
      <div class="card m-5">
        <div class="row g-0 d-flex align-items-center">
          <div class="col-lg-4 d-none d-lg-flex">
            <img src="https://images.pexels.com/photos/6589160/pexels-photo-6589160.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&dpr=1" alt=""
              class="w-100 rounded-t-5 rounded-tr-lg-0 rounded-bl-lg-5" />
          </div>
          <div class="col-lg-8">
            <div class="card-body py-5 px-md-5">
            <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Log in as Keeper</h3>
              <form action="<?php echo FRONT_ROOT."keeper/login" ?>" method="post">
                <!-- Email input -->
                ...
                <div class="row mb-4">
                  <div class="col">
                    <!-- Simple link -->
                    <p>Don't have an account? <a href="<?php echo FRONT_ROOT."keeper/registerview" ?>" class="link-info">Register here</a></p>
                  </div>
                </div>
